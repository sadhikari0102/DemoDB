...
#line 2 "Parser.y" /* yacc.c:339  */
	...
	char *table, *file, *oldtable, *output;
...
{
       0,    97,    97,   104,   111,   117,   124,   130,   135,   141,
     155,   169,   176,   183,   189,   194,   201,   209,   215,   221,
     228,   235,   243,   253,   266,   276,   282,   291,   302,   307,
     312,   317,   323,   337,   346,   354,   363,   372,   379,   386,
     394,   402,   410,   418,   430,   438,   446
};
#endif
...
static const char *const yytname[] =
{
  ...
  "DROP", "SORTED", "ON", "'('", "')'", "','", "'-'", "'+'", "'*'", "'/'",
  "'<'", "'>'", "'='", "$accept", "SQL", "Attrs", "Sort", "WhatIWant",
...
#line 112 "Parser.y" /* yacc.c:1646  */
    {
	table = (yyvsp[-5].actualChars);
	attrs = (yyvsp[-3].myAttrs);
}
...
#line 118 "Parser.y" /* yacc.c:1646  */
    {
	table = (yyvsp[-7].actualChars);
	attrs = (yyvsp[-5].myAttrs);
	sort = (yyvsp[0].mySort);
}
...
#line 142 "Parser.y" /* yacc.c:1646  */
    {
	(yyval.myAttrs) = (struct AttrList *) malloc (sizeof (struct AttrList));
	(yyval.myAttrs)->name = (yyvsp[-1].actualChars);
	if(strcmp((yyvsp[0].actualChars),"INTEGER")==0)
		(yyval.myAttrs)->type = 0;
	else if(strcmp((yyvsp[0].actualChars),"DOUBLE")==0)
		(yyval.myAttrs)->type = 1;
	else if(strcmp((yyvsp[0].actualChars),"STRING")==0)
		(yyval.myAttrs)->type = 2;
	//$$->type = $2;
	(yyval.myAttrs)->next = NULL;
}
...
#line 156 "Parser.y" /* yacc.c:1646  */
    {
	(yyval.myAttrs) = (struct AttrList *) malloc (sizeof (struct AttrList));
	(yyval.myAttrs)->name = (yyvsp[-3].actualChars);
	if(strcmp((yyvsp[-2].actualChars),"INTEGER")==0)
		...
		(yyval.myAttrs)->type = 2;
	//$$->type = $4;
	(yyval.myAttrs)->next = (yyvsp[0].myAttrs);
}
...
#line 170 "Parser.y" /* yacc.c:1646  */
    {
	(yyval.mySort) = (struct NameList *) malloc (sizeof (struct NameList));
	(yyval.mySort)->name = (yyvsp[0].actualChars);
	(yyval.mySort)->next = NULL;
}
...
#line 177 "Parser.y" /* yacc.c:1646  */
    {
	(yyval.mySort) = (struct NameList *) malloc (sizeof (struct NameList));
	(yyval.mySort)->name = (yyvsp[-2].actualChars);
	(yyval.mySort)->next = (yyvsp[0].mySort);
}
